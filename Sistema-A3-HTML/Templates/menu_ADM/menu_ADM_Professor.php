...
<script>
    // Função para redirecionar para a página do aluno
    function goToPage(index) {
        // Aqui você pode colocar a lógica para redirecionar para outra página com as informações do aluno
        window.location.href = `menu_ADM_Aluno.php?id=${index}`;
    }

    // Função para filtrar os alunos conforme o que é digitado
    function filterName() {
